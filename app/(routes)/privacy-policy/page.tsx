            ...
            <div className="text-center">
              <nav className="mb-2 text-white/80">
                <ol className="inline-flex items-center space-x-2">
                  ...
                  <li className="opacity-100">{t('routes.policy.privacy.title')}</li>
                </ol>
              </nav>
              <h1 className="text-4xl md:text-5xl font-bold">{t('routes.policy.privacy.title')}</h1>
            </div>
          </div>
        </section>
