          ...
          <section className="py-16 md:py-20">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-gray-900">
              <div className="max-w-4xl mx-auto rounded-lg p-8 md:p-12">
                ...
                <p className="text-base md:text-lg leading-relaxed mb-4">
                  10.1 Either party may terminate these Terms and Conditions on one day&apos;s written notice.
                </p>
                <p className="text-base md:text-lg leading-relaxed mb-4">
                  10.2 We may terminate these Terms and Conditions with immediate effect if you:
                </p>
                <ul className="list-disc pl-6 text-base md:text-lg leading-relaxed space-y-2">
